...
if [ $down -eq 1 ]; then
    ...
    ncl nc2cpt_prob_s2s_v2.ncl
    mv outfile.txt t2m_1996-2014_3inits_MFR_ensmean_week2_predictor.tsv
    rm infile.nc
    ...
    ncl nc2cpt_prob_s2s_v2.ncl
    mv outfile.txt t2m_1996-2014_3inits_MFR_ensmean_week3_predictor.tsv
    rm infile.nc
    ...
    ncl nc2cpt_prob_s2s_v2.ncl
    mv outfile.txt t2m_1996-2014_3inits_MFR_ensmean_week4_predictor.tsv
    rm infile.nc
    ...
    ncl nc2cpt_prob_s2s_v2.ncl
    mv outfile.txt t2m_1996-2014_3inits_MFR_ensmean_week5_predictor.tsv
    rm infile.nc
    ...
    ncl nc2cpt_prob_s2s_v2.ncl
    mv outfile.txt t2m_1996-2014_3inits_MFR_ensmean_week6_predictor.tsv
    rm infile.nc
...
../output/t2m_Kendallstau_noMOSprob_MFR_Week'${we}'.txt
...
../output/t2m_Ignorance_noMOS_MFR_Week'${we}'

437 # Probabilistic skill maps
131 # GROC
../output/t2m_GROC_noMOS_MFR_Week'${we}'

437 # Probabilistic skill maps
122 # Ranked Probability Skill Score
../output/t2m_RPSS_noMOS_MFR_Week'${we}'

437 # Probabilistic skill maps --category-specific
202 # Ignorance
3
../output/t2m_IGNabove_noMOS_MFR_Week'${we}'
437 # Probabilistic skill maps --category-specific
202 # Ignorance
1
../output/t2m_IGNbelow_noMOS_MFR_Week'${we}'

437 # Probabilistic skill maps --category-specific
202 # Reliability (ignorance)
3
../output/t2m_ReliabIGNabove_noMOS_MFR_Week'${we}'

437 # Probabilistic skill maps --category-specific
202 # Reliability (ignorance)
1
../output/t2m_ReliabIGNbelow_noMOS_MFR_Week'${we}'

437 # Probabilistic skill maps --category-specific
202 # Reliability (Brier)
3
../output/t2m_ReliabBrierabove_noMOS_MFR_Week'${we}'

437 # Probabilistic skill maps --category-specific
202 # Reliability (Brier)
1
../output/t2m_ReliabBrierbelow_noMOS_MFR_Week'${we}'

#0 # Stop saving  (not needed in newest versions of CPT)

0 # Exit
END
' > noMOSSkill_MFR_t2m_Week${we}.cpt
...
chmod 755 noMOSSkill_MFR_t2m_Week${we}.cpt

#Run for no-standardized anomalies
rm -Rf ../input/predictor_Week${we}.tsv
ln -s ../input/t2m_1996-2014_3inits_MFR_ensmean_week${we}_predictor.tsv ../input/predictor_Week${we}.tsv
./noMOSSkill_MFR_t2m_Week${we}.cpt
