#! /bin/bash
#Script to assess skill of seasonal SST deterministic hindcasts and observations 
...
clear
echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
echo Script to assess skill of seasonal SST deterministic hindcasts and observations
...
../input/SST_FLOR_1tier_JJA_1982-2017.tsv
...
../input/SST_HadSST_JJA_1982-2017.tsv
...
../output/SST_Kendallstau_1TIER_y'${y}'_train'${i}'.txt
...
#../output/SST_Spearman_1TIER_y'${y}'_train'${i}'.txt

#413 # cross-validated skill maps
#3 # save 2AFC score
#../output/SST_2AFC_1TIER_y'${y}'_train'${i}'.txt

#413 # cross-validated skill maps
#10 # save 2AFC score
#../output/SST_RocBelow_1TIER_y'${y}'_train'${i}'.txt

#413 # cross-validated skill maps
#11 # save 2AFC score
#../output/SST_RocAbove_1TIER_y'${y}'_train'${i}'.txt

#0 # Stop saving  (not needed in newest version of CPT)

0 # Exit
END
' > 1TIERSkill_SST_y${y}_train${i}.cpt 

#Execute CPT and produce skill maps
echo ---------------------------------------------------
echo Executing CPT and producing skill maps for training length $i of year $y...
chmod 755 1TIERSkill_SST_y${y}_train${i}.cpt  
./1TIERSkill_SST_y${y}_train${i}.cpt > cpt_y${y}_train${i}.log
